/*  Name: Julia Xie
    ...
    Assignment: This program will animate the second animation of the fox.
		The fox will continue to chase the rabbit across the second background, from left to right.
*/
...
public class Fox2 extends Thread        // creates a new class called Fox1
{
    private Console c;      // class to make fox2

    public void drawFox2 ()
    {
	...
	// used to delay the entrance of the fox
	try
	{
	    sleep (600);
	}
    ...
    public Fox2 (Console con)   // console is passed as an argument so that all animation display on the same console
    {
	c = con;
    }
    ...
    public void run ()
    {
	drawFox2 ();        // executes drawFox2 method
    }
}
